...
function preload() {
  ...
  game.load.tilemap('Mystery_Map', 'img/Mystery_Map.json', null, Phaser.Tilemap.TILED_JSON);
  game.load.image('tiles1', 'img/Mystery.png'); //load tileset corresponding level1single.json tilemap
  game.load.image('tiles2', 'img/Mystery.png'); //load tileset corresponding level1single.json tilemap
}
...
function create() {
  ...
  map = game.add.tilemap('Mystery_Map');
  map.addTilesetImage('Mystery_Tiles', 'tiles1');
