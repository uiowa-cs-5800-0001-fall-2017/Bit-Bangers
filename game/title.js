...
function preload() {
    ...
    //  Firefox doesn't support mp3 files but ogg is way too big
    game.load.audio('title2', ['audio/title.mp3']);
}
...
function update() {
    ...
    if (game.input.activePointer.isDown)
    {
        ...
        $.getScript('game/level1.js', function()
        {
